### <font color=deepskyblue>获取 render_map 的 数据版本</font>
...
```
其中 `render-map-service-v2-test-6b44cb45fc-hkpld` 为测试版本， 一般后台功能有修改，先修改测试版本，等前端测试通过后，再将主版本改过去
查看版本
```
...
### <font color=deepskyblue>修改 yaml</font>
```yaml
---
apiVersion: apps/v1
kind: Deployment
...
spec:
  ...
  selector:
    ...
    app: render-map-service-v2-nanjing # 修改这里，添加了 nanjing
```
### <font color=deepskyblue>创建该服务</font>
```
kubectl -n ridesharing create -f service-render-map-cache.yaml
```
### <font color=deepskyblue>查看运行结果</font>
```
